...
**Stage:** alpha (v0.0.19) — installers are onboarding helpers, not a GA release channel yet. Pro users can optionally sign in with `liminal login` for managed inference instead of pasting an API key.
