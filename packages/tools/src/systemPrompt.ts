...
- **R-RECIPE-REUSE**: When a **[KNOWN RECIPE]** block appears in [WORLD CONTEXT], a tool-phase sequence has worked repeatedly for similar goals — adopt it as the plan skeleton unless the task clearly differs. Do not re-derive a strategy from scratch when a high-reuse recipe matches.
