...
export const TOOL_FAMILIES: Record<string, { description: string; tools: readonly string[] }> = {
  ...
  xero: {
    description:
      "Xero REST — accounting AR/AP, reports, files, projects, payroll, composites (hosted OAuth).",
    tools: [
      ...
      "xero_files_upload",
      "xero_files_delete",
      "xero_files_list_folders",
      "xero_files_get_folder",
      "xero_files_list_associations",
      "xero_list_projects",
      "xero_get_project",
      "xero_create_project",
      "xero_update_project",
      "xero_list_project_tasks",
      "xero_create_project_task",
      "xero_list_project_time_entries",
      "xero_create_project_time_entry",
      "xero_list_project_users",
      "xero_payroll_region",
      "xero_list_payroll_employees",
      "xero_get_payroll_employee",
      "xero_list_payroll_payruns",
      "xero_get_payroll_payrun",
      "xero_list_payroll_timesheets",
      "xero_get_payroll_timesheet",
      "xero_get_payroll_settings",
      "xero_get_payroll_payslip",
      "xero_create_payroll_timesheet",
      "xero_bank_feeds_info",
      "xero_upsert_contact",
      "xero_project_to_invoice",
      "xero_month_end_close",
      "xero_duplicate_invoice_check",
      "xero_create_payroll_payrun",
      "xero_update_payroll_payrun",
      "xero_update_payroll_employee",
      "xero_update_payroll_timesheet",
