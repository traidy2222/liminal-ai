...
export const HARNESS_ENV_DEFAULTS: Readonly<Record<string, string>> = {
  ...
  AGENT_WEB_SEARCH_FALLBACK: "1",
  AGENT_WEB_FETCH_SERPER: "1",
  AGENT_SERPER_GL: "us",
  AGENT_SERPER_HL: "en",
  ...
  AGENT_AWS_MCP_ENDPOINT: "",
  AGENT_AWS_MCP_SERVICE: "aws-mcp",
  AGENT_AWS_CONNECT_ON_BOOT: "0",
  AGENT_IDA_MCP: "0",
  AGENT_IDA_SIDECAR_ENABLE: "1",
  AGENT_IDA_SIDECAR_CMD: "idalib-mcp",
  AGENT_IDA_SIDECAR_PORT: "8745",
  AGENT_IDA_MCP_URL: "",
  AGENT_IDA_GUI_MCP_URL: "",
  AGENT_IDA_CONNECT_ON_BOOT: "0",
  AGENT_GOOGLE_GMAIL_SEND: "1",
  AGENT_GOOGLE_CALENDAR_REST: "1",
  AGENT_GOOGLE_ANALYTICS_REST: "1",
  AGENT_GOOGLE_SEARCH_CONSOLE_REST: "1",
  AGENT_YOUTUBE_REST: "1",
  AGENT_GOOGLE_OFFICE_REST: "1",
  AGENT_WORKSPACE_BOUND: "0",
  AGENT_SHEETS_AUTO_FIT: "1",
  AGENT_EMAIL_STYLE_INFER: "1",
  AGENT_AGENTCARD: "1",
  AGENT_AGENTCARD_CMD: "agentcard",
  AGENT_AGENTCARD_TIMEOUT_MS: "120000",
  AGENT_AGENTCARD_SIGNUP_TIMEOUT_MS: "330000",
  ...
  AGENT_XERO_OAUTH_SCOPE_STYLE: "granular", // granular = post-2026-03-02 apps; legacy = pre-migration broad scopes
  ...
  AGENT_LIMINAL_APPS: "0",
  AGENT_LIMINAL_APPS_DESKTOP: "0",
  AGENT_APP_MAX_COUNT: "8",
  AGENT_APP_HTML_MAX_BYTES: "409600",
  AGENT_APP_PROXY_MAX_HOSTS: "8",
  AGENT_APP_REFRESH_ENABLED: "1",
  AGENT_APP_REFRESH_MIN_INTERVAL_MS: "300000",
  AGENT_HEARTBEAT: "0",
